...
CD0 = 0.0317; %CD_0
W0 = 1373.48; %peso liq do avião: peso aviao + galoes + passageiro + bagagem
...
rho = 0.001764324392;  %densidade 3000m 0.001764324392  --0.0023769
...
RC_MAX = ((n*PM)/W0) - 0.8776*sqrt((W0/S)/(rho*CD0))*(1/(LD_MAX^(3/2)));
...
TETO_ABSOLUTO = -19867*log((W0/PA_0)*sqrt((2*W0)/(S*rho)*((0.7436*(CD0^(1/4)))/((e*RA)^(3/4)))));
...
fprintf('Autonomia (E) = %1.4f s\n',E);
fprintf('Alcance (R) = %1.4f m\n',R);